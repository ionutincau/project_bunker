...
## 🏆 ENDING 1: HUMANITY SAVED (True Ending)
...
3. **Interrogate Lisa** first (costs 2:00)
   ...
   - Result: You get the B-Flat frequency clue ✓
4. **Interrogate Mina** (costs 2:00)
   - Choose: **"Mina. Look at me. Breathe. You built the bridge. You can close it."**
   - Result: Mina's trust increases ✓
5. **Optional: Interrogate Trent** for extra info
   - Choose: "What do you mean by a mechanical lock?"
...
9. **Final Selection (01:00)** - The critical moment
   - Choose: **"Pull in MINA (The Architect)"**
10. **Victory!**
    - Xena tells Mina the frequency is B-Flat
    - Mina inverts the frequency and stops the signal
    - World is saved (but they're stuck in the bunker)
...
- He's been possessed by the Desync
- He thanks you for bringing the virus inside
- Xena gets assimilated into the hive mind
- **Game Over: Humanity falls**

**Why This Fails:** The Desync isn't software - it's a frequency. Kai's approach is wrong.
...
- But the magnetic shielding was powered by that circuit!
- Without shields, the Desync floods in instantly
- Both Xena and Trent become statues before hitting the floor
- **Game Over: Humanity falls**

**Why This Fails:** Turning off power kills the shields that were protecting them.
...
- She hums a peaceful lullaby
- Teal light consumes them both
- They die peacefully
- **Game Over: Humanity falls**

**Why This Fails:** Lisa understands the problem but lacks the technical means to solve it.

---

## 🎼 ENDING 5: THE WRONG SONG (Tragic Failure)
...
2. **Either skip Lisa OR dismiss her**
   - If talking to Lisa, choose: "I don't have time for poetry"
...
- Xena tells Mina to guess
- Mina explains there are millions of possible tones
- She tries a random code
- It fails - the bridge stays open
- **Game Over: Humanity falls**

**Why This Fails:** Right person, right trust, but missing critical information.

---

## 😱 ENDING 6: FEAR IS THE KILLER (Tragic Failure)
...
2. **Interrogate Mina** - Be harsh/forceful
   - Choose: **"Snap out of it! Give me the code!"**
...
- She says: "I'm too scared... I can't do it!"
- She collapses before she can type
- Mina's skin turns gray, eyes glow teal
- She desyncs before saving the world
- **Game Over: Humanity falls**

**Why This Fails:** Right person, right knowledge, but broken trust.

---

## 🎮 Comparison Chart

| Ending | Choose | Knowledge | Trust | Result |
|--------|--------|-----------|-------|--------|
| **Humanity Saved** | Mina | B-Flat ✓ | High ✓ | ✅ WIN |
| **Wrong Song** | Mina | None ✗ | High ✓ | ❌ FAIL |
| **Fear is Killer** | Mina | B-Flat ✓ | Low ✗ | ❌ FAIL |
| **Trojan Horse** | Kai | Any | Any | ❌ FAIL |
| **Brute Force** | Trent | Any | Any | ❌ FAIL |
| **Quiet Death** | Lisa | Any | Any | ❌ FAIL |
...
1. **Use Skip/Ctrl** - Ren'Py lets you skip read dialogue (hold Ctrl)
2. **Save Before Final Choice** - Save at 01:00, see all endings quickly
3. **Try Different Orders** - Interrogate characters in different sequences
4. **Experiment** - Try different dialogue responses to see variations
5. **Check Variables** - Some players enable console to view trust/clue values
...
**Optimal interrogation order:** Lisa → Mina → (Wait/Others)
...
**Good luck, Agent. Try to save humanity!**
