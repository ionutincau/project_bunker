...
label hub_entry:
    scene airlock_red with dissolve
...
label turning_point:
    ...
    scene airlock_teal with hpunch
...
label deterioration:
    ...
    scene hud_glitch with dissolve
    ...
    scene glass_fracture with vpunch
...
label final_selection:
    scene blast_doors with dissolve
